"""Dataclasses for BLE-connected water fountains."""
...
class SettingsBleWaterFountain(BaseModel):
    """Dataclass for BLE water fountain settings.
    -> BleWaterFountain subclass.
    """
...
class StatusBleWaterFountain(BaseModel):
    """Dataclass for BLE water fountain runtime status.
    -> BleWaterFountain subclass.
    """
...
class BleWaterFountainRecord(BaseModel):
    """Dataclass for BLE water fountain work record data."""
...
class BleWaterFountain(BaseModel):
    """Dataclass for BLE water fountain data.
    Supported devices = W4, W5, CTW2, CTW3
    """
    ...
    settings: SettingsBleWaterFountain | None = None
    sn: str
    status: StatusBleWaterFountain | None = None
    ...
    device_records: list[BleWaterFountainRecord] | None = None
